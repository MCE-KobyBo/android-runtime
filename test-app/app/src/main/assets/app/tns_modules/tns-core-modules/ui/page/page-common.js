...
var PageBase = (function (_super) {
    ...
    function PageBase() {
        _super.call(this);
        this._cssFiles = {};
        this._styleScope = new style_scope_1.StyleScope();
    }
    ...
    PageBase.prototype.refreshCssIfAppCssChanged = function () {
 ...
 */
exports.androidStatusBarBackgroundProperty = new content_view_1.CssProperty({ name: "androidStatusBarBackground", cssName: "android-status-bar-background",
