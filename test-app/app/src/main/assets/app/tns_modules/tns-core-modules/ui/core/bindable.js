...
var view_base_1 = require("ui/core/view-base");
...
var Binding = (function () {
    ...
    Binding.prototype.clearBinding = function () {
        this.clearSource();
        this.updateTarget(view_base_1.unsetValue);
    };
    Binding.prototype.updateTarget = function (value) {
        if (this.updating) {
            return;
        }
        this.updateOptions(this.targetOptions, types.isNullOrUndefined(value) ? view_base_1.unsetValue : value);
    };
    ...
    Binding.prototype.getParentView = function (target, property) {
        if (!target || !(target instanceof view_base_1.ViewBase)) {
    ...
    Binding.prototype.updateOptions = function (options, value) {
        ...
        this.updating = true;
        try {
            var isView = optionsInstance instanceof view_base_1.ViewBase;
            if (isView &&
                view_base_1.isEventOrGesture(options.property, optionsInstance) &&
                types.isFunction(value)) {
                optionsInstance.off(options.property, null, optionsInstance.bindingContext);
                optionsInstance.on(options.property, value, optionsInstance.bindingContext);
            }
            else if (!isView && optionsInstance instanceof observable_1.Observable) {
