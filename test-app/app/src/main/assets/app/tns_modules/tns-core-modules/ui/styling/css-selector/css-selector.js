...
var IdSelector = (function (_super) {
    ...
    IdSelector = __decorate([
        SelectorProperties(65536 /* Id */, 3 /* Id */, Match.Static)
    ], IdSelector);
    return IdSelector;
}(SimpleSelector));
...
var ClassSelector = (function (_super) {
    ...
    ClassSelector = __decorate([
        SelectorProperties(256 /* Class */, 2 /* Class */, Match.Static)
    ], ClassSelector);
...
var AttributeSelector = (function (_super) {
    ...
    AttributeSelector = __decorate([
        SelectorProperties(256 /* Attribute */, 0 /* Attribute */, Match.Dynamic)
    ], AttributeSelector);
...
var PseudoClassSelector = (function (_super) {
    ...
    PseudoClassSelector = __decorate([
        SelectorProperties(256 /* PseudoClass */, 0 /* PseudoClass */, Match.Dynamic)
    ], PseudoClassSelector);
