    ...
    function InheritedProperty(options) {
        ...
        var setFunc = function (valueSource) { return function (value) {
            ...
            if (value === exports.unsetValue) {
                ...
                if (parent_1 && parent_1[sourceKey] !== 0 /* Default */) {
            ...
            if (currentValue !== newValue) {
                var reset_1 = newValueSource === 0 /* Default */;
                that.eachChild(function (child) {
                    var childValueSource = child[sourceKey] || 0 /* Default */;
                    if (reset_1) {
        ...
        var setInheritedValue = setFunc(1 /* Inherited */);
...
var CssProperty = (function () {
    function CssProperty(options) {
        ...
        function setCssValue(value) {
            var reset = value === exports.unsetValue;
            var currentValueSource = this[sourceKey] || 0 /* Default */;
...
var CssAnimationProperty = (function () {
    function CssAnimationProperty(options) {
        ...
        var defaultPropertyDescriptor = descriptor(defaultValueKey, 0 /* Default */, false, false, false);
        var cssPropertyDescriptor = descriptor(cssValue, 2 /* Css */, false, false, false);
        var stylePropertyDescriptor = descriptor(styleValue, 3 /* Local */, true, true, true);
        var keyframePropertyDescriptor = descriptor(keyframeValue, 4 /* Keyframe */, false, false, false);
...
var InheritedCssProperty = (function (_super) {
    ...
    function InheritedCssProperty(options) {
        ...
        var setFunc = function (valueSource) { return function (value) {
            ...
            if (changed) {
                ...
                view_1.eachChild(function (child) {
                    ...
                    var childValueSource = childStyle[sourceKey] || 0 /* Default */;
                    if (reset) {
                        if (childValueSource === 1 /* Inherited */) {
        ...
        var setDefaultFunc = setFunc(0 /* Default */);
        var setInheritedFunc = setFunc(1 /* Inherited */);
...
function inheritablePropertyValuesOn(view) {
    ...
    for (var _i = 0, inheritableProperties_1 = inheritableProperties; _i < inheritableProperties_1.length; _i++) {
        ...
        var valueSource = view[sourceKey] || 0 /* Default */;
...
function inheritableCssPropertyValuesOn(style) {
    ...
    for (var _i = 0, inheritableCssProperties_1 = inheritableCssProperties; _i < inheritableCssProperties_1.length; _i++) {
        ...
        var sourceKey = prop.sourceKey;
        var valueSource = style[sourceKey] || 0 /* Default */;
        if (valueSource !== 0 /* Default */) {
            // use prop.name as it will return value or default value.
            // prop.key will return undefined if property is set t the same value as default one.
...
function propagateInheritableProperties(view) {
    ...
    view.eachChild(function (child) {
        for (var _i = 0, inheritablePropertyValues_1 = inheritablePropertyValues; _i < inheritablePropertyValues_1.length; _i++) {
            ...
            var sourceKey = prop.sourceKey;
            var currentValueSource = child[sourceKey] || 0 /* Default */;
...
function propagateInheritableCssProperties(style) {
    ...
    view.eachChild(function (child) {
        for (var _i = 0, inheritableCssPropertyValues_1 = inheritableCssPropertyValues; _i < inheritableCssPropertyValues_1.length; _i++) {
            ...
            var currentValueSource = style_2[sourceKey] || 0 /* Default */;
            if (currentValueSource <= 1 /* Inherited */) {
                prop.setInheritedValue.call(style_2, pair.value, 1 /* Inherited */);
            }
        }
        return true;
    });
